...
var locations = [
  '노인정', '사우나', '성인용품점', '러브호텔', '피시방', '국어학원', '수학학원', '영어학원', '과학학원', '기숙학원', '기숙사', '독서실', '대형마트', '스터디카페', '노약자석', '임산부석', '장애인석', '대형마트시식코너', '경찰서', '대중목욕탕', '무료급식소', '초등학교', '중학교', '고등학교', '편의점', '학원가', '어린이보호구역', '장례식장', '수능갤러리', '공사장', '세탁소', '애견카페', '고아원', '풋살장', '미용실', '찜질방', '군부대', '납골당', '고구려대학교', '논', '밭', '동사무소', '수능시험장', '전통시장', '롯데마트', '신천지', '스키장상급자코스', '태권도장', '놀이터', '시공의폭풍', '헬스장', '할매순댓국밥', '버스정류장', '삼성프라자', '국회의사당', '훈련소', '흡연실', '아파트관리사무소', '생활관', '서점', '도서관', '급식실', '휴대폰대리점', '주유소', '공원', '에버랜드', '롯데월드', '지하철', '지하철역', '시내버스', '고속버스', 
