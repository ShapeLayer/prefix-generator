var jobs = [
  ...
  ['카사노바', '소리없는방귀빌런', '절대강자', '노숙자', '진상손님', '술고래', '터줏대감', '관짝춤머신', '화장실문지기']
]
...
var locations = [
  ...
  ['폐지줍는할머니', '포식자', '수능시험장', '결국사람', '펩시', '유모차레이스', '엄마가준비한식사', '어린이보호구역', '노인에게서슴지않고', 'Pornhub', '어린이탐정단', '냉탕에오줌싸서', '미래통합당', '스키장상급자코스', '장례식장', '고구려대학교', '고아원', '수능갤러리', '공사장', '애견카페', '군부대', '훈련소', '납골당', '논', '밭', '롯데마트', '시공의폭풍', '신천지', '웹툰미리보기사이트', '파인애플피자']
]
/* 목록이 길어져서 분리
작성규칙:
인덱스 0 : 장소
