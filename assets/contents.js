...
var locations = [
  ...
  ['폐지줍는할머니', '포식자', 'AD', '수능시험장', '결국사람', '펩시', '유모차레이스', '엄마가준비한식사', '어린이보호구역', '노인에게서슴지않고', 'Pornhub', '어린이탐정단', '냉탕에오줌싸서', '스키장상급자코스', '장례식장', '고구려대학교', '고아원', '수능갤러리', '공사장', '애견카페', '군부대', '훈련소', '납골당', '논', '밭', '롯데마트', '시공의폭풍', '웹툰미리보기사이트', '파인애플피자', '비트코인', '도박', '토토', '대학원연구실', '내다버린', '식물인간에게', '온라인클래스', '시대에']
]
// 비활성화:  '아이언', '실버', '골드',
/* 목록이 길어져서 분리
작성규칙:
...
var exampleNames = [
  '엄종현', '홍길동', '강철수', '박종현', '문성수', '유현재', '고강건', '안주현', '김민식', '김준표', '오민서'
]
// '정지웅', '노강민'
