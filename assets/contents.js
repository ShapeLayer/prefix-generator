var jobs = [
  ['도둑', '연쇄절도범', '수호자', '담당일진', '약탈자', '방문판매원', '파괴자', '테러범', '와(과)교제사실을들킨', '뺏어먹는', '관찰자', '밑장빼기9단', '추종자', '셔틀', '지배자'],
  ['카사노바', '소리없는방귀빌런', '절대강자', '노숙자', '진상손님', '술고래', '터줏대감', '관짝춤머신', '화장실문지기', '모쏠아다', '탈모인협회장', '지박령', '푸드파이터', '잔반처리반', '앞을서성이는']
]

var locations = [
  ['노인정', '사우나', '성인용품점', '러브호텔', '피시방', '국어학원', '수학학원', '영어학원', '과학학원', '기숙학원', '기숙사', '독서실', '대형마트', '스터디카페', '노약자석', '임산부석', '장애인석', '대형마트시식코너', '경찰서', '대중목욕탕', '무료급식소', '유치원', '초등학교', '중학교', '고등학교', '편의점', '학원가', '세탁소', '풋살장', '미용실', '찜질방', '동사무소', '전통시장', '태권도장', '놀이터', '헬스장', '할매순댓국밥', '버스정류장', '삼성프라자', '국회의사당', '흡연실', '아파트관리사무소', '생활관', '서점', '도서관', '급식실', '휴대폰대리점', '주유소', '공원', '에버랜드', '롯데월드', '지하철', '지하철역', '시내버스', '고속버스', '중화반점', '동대문시장', '맘스터치', '우정사업본부', '산채비빔밥먹는스님앞에서'],
  ['폐지줍는할머니', '포식자', 'AD', '수능시험장', '결국사람', '펩시', '유모차레이스', '엄마가준비한식사', '어린이보호구역', '노인에게서슴지않고', 'Pornhub', '어린이탐정단', '냉탕에오줌싸서', '미래통합당', '스키장상급자코스', '장례식장', '고구려대학교', '고아원', '수능갤러리', '공사장', '애견카페', '군부대', '훈련소', '납골당', '논', '밭', '롯데마트', '시공의폭풍', '신천지', '웹툰미리보기사이트', '파인애플피자', '비트코인', '도박', '토토', '대학원연구실', '내다버린', '식물인간에게', '온라인클래스', '시대에']
]
// 비활성화:  '아이언', '실버', '골드',
/* 목록이 길어져서 분리
작성규칙:
...
var objects = [
  '수건', '때밀이수건', '할머니때밀이수건', '흑돌', '백돌', '러브젤', '노트', '교재', '연필심', '샤프심', '휴대폰충전기', '마우스', '지우개', '테이저건', '콘돔', '분필', '젓가락', '잔디', '바리깡', '틀니', '잼민이휴대폰', '할아버지지팡이', '종이컵', '비타민', '리코더', '줄넘기', '프로틴', '단백질', '다데기', '탈모치료제', '생각하는의자', '단무지', '진라면순한맛', '짝퉁명품', '할머니리어카', '진동벨', '이쑤시개', '영양갱', '계란장수계란'
]

var exampleNames = [
  '엄준식', '홍길동', '강철수', '박종현', '문성수', '유현재', '고강건', '안주현', '김민식', '김준표'
]
// '정지웅', '노강민'
